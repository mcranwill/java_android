...
public class apples {
	public static void main(String args[]){
		...
		potpie obj = new potpie(4,5,6);
		AppleJacks newObj = new AppleJacks();
		AppleJacks newObj1 = new AppleJacks(11, 7);
		AppleJacks newObj2 = new AppleJacks(17, 58, 12);
		System.out.println(newObj.toMilitary());
		System.out.println(newObj1.toMilitary());
		System.out.println(newObj2.toMilitary());
		// Math class System.out.println(Math.sqrt(.912));
		/*function calls
		display(bucky);
		System.out.println(average(12,432,542,62,64,12,64,74,23));
		display(secondarray);
